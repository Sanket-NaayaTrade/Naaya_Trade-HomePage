...
import TradeShowImageOne from "../assets/tradeShowOne.png";
import TradeShowImageTwo from "../assets/tradeShowTwo.png";
import TradeShowImageThree from "../assets/tradeShowThree.png";
      ...
      >
        ...
        <div className="">
          <SwiperSlide className="!w-[400px] !mr-[30px] !important"> 
              ...
              <div className="flex border items-center rounded-2xl w-[402px] h-[181px] py-[40px] px-[20px] gap-x-4 text-left">
                <div>
                  <img
...
export default NavbarSwiperComponent;
