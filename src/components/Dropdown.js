  ...
  <DropdownMenu>
    <DropdownMenuTrigger asChild>
      <div className="flex gap-x-[10px] cursor-pointer">
        <img src={require("../assets/India-flag.png")} className="h-[12px]" />
      ...
      <div className="flex flex-col justify-start pb-[20px]">
        ...
        <div className="flex justify-between items-center px-2 border-[1px] py-2 rounded-md">
          <div className="flex items-center gap-x-2">
            <img
              src={require("../assets/India-flag.png")}
              className="h-[10px]"
              alt="India Flag"
            />
...
export const Languages = (
  <DropdownMenu>
    <DropdownMenuTrigger asChild>
      <div className="flex items-center gap-x-2">
        <p>Language -</p>
        <img src={require("../assets/USAFlag.png")} className="h-[12px]" />
        <p>English US</p>
...
const categoriesType = [
  { type: "Consumer Electronics", img: require("../assets/camera.png") },
  { type: "Fashion & Apparels", img: require("../assets/camera.png") },
  { type: "Fashion & Apparels", img: require("../assets/camera.png") },
  { type: "Sports & Entertainment", img: require("../assets/camera.png") },
  { type: "Industrial Machinery", img: require("../assets/camera.png") },
  { type: "Home & Garden", img: require("../assets/camera.png") },
  { type: "Beauty & Personal Care", img: require("../assets/camera.png") },
  { type: "Animal & pet", img: require("../assets/camera.png") },
];

const consumer = [
  { img: require("../assets/watch.png"), productTitle: "Smart Watches" },
  { img: require("../assets/watch.png"), productTitle: "Smart Watches" },
  { img: require("../assets/watch.png"), productTitle: "Smart Watches" },
  { img: require("../assets/watch.png"), productTitle: "Smart Watches" },
  { img: require("../assets/watch.png"), productTitle: "Smart Watches" },
